...
class DobotApiDashboard(DobotApi):
    ...
    def EnableRobot(self):
        ...
        return self.wait_reply(is_log=False)
    ...
    def DI(self, index,is_log=True):
        string = "DI({:d})".format(index)
        self.send_data(string,is_log)
        return self.wait_reply(is_log=is_log)
    ...
    def GetErrorID(self):
        ...
        """
        string = "GetErrorID()"
        self.send_data(string,is_log=False)
        return self.wait_reply(is_log=False)
